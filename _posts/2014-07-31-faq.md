...
Eg. if you have server1 (192.168.1.3) which should be able to make RPC calls to server2 (192.168.1.3) you must have this in the conf.php on both servers: `define('RPC_ALLOWED_CLIENTS', '192.168.1.2 192.168.1.3');`
